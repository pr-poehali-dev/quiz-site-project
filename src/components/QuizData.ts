...
export const getQuizResults = (answers: number[]) => {
  ...
  let message = "";
  if (score >= 80) {
    message = "Отлично! Вы хорошо знаете стандарты обслуживания в общежитиях Президентской академии. Мы будем рады видеть вас в нашей команде!";
  } else if (score >= 60) {
    message = "Хороший результат! Вы знакомы с основными принципами коммуникации с гостями, но есть моменты, которые стоит повторить.";
  } else if (score >= 40) {
    message = "Неплохо, но вам стоит лучше изучить стандарты обслуживания в общежитиях Президентской академии.";
  } else {
    message = "Вам необходимо более детально ознакомиться со стандартами обслуживания. Предлагаем пройти обучение по коммуникации с гостями.";
  }
